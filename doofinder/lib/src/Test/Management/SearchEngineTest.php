...
namespace Doofinder\WP\Api\Test\Management;
...
class SearchEngineTest extends \PHPUnit_Framework_TestCase
{
  ...
  {
    $this->client = $this->prophesize('\Doofinder\WP\Api\Management\Client');
  ...
  public function testStatsReturnsAggregatesIteratorWithDifferentDates($from_date, $to_date)
  {
    ...
    $this->assertInstanceOf(
      '\Doofinder\WP\Api\Management\AggregatesIterator', $aggregatesIterator
    );
  ...
  public function testTopTermsReturnsTopTermsIteratorWithDifferentDatesAndTerms($term, $from_date, $to_date)
  {
    ...
    // returns a aggregatesIterator
    $this->assertInstanceOf(
      '\Doofinder\WP\Api\Management\TopTermsIterator', $iterator
    );
    // with the right searchEngine
    $this->assertEquals(
  ...
  /**
   * @expectedException \Doofinder\WP\Api\Management\Errors\BadRequest
   */
